...
export function AdminProductCreatePage() {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      addToast({ title: 'Đã tạo sản phẩm. Thêm phiên bản và hình ảnh ngay nào.', variant: 'success' })
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-sm text-muted-foreground">Điền thông tin rồi lưu để thêm phiên bản và hình ảnh.</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[420px_1fr] lg:items-start">
        ...
        {/* RIGHT — variants/media locked until saved */}
        <Panel>
          <div className="flex flex-col items-center gap-3 px-6 py-12 text-center">
            ...
            <p className="text-sm font-medium text-foreground">Phiên bản &amp; hình ảnh</p>
            <p className="max-w-sm text-sm text-muted-foreground">
              Lưu sản phẩm trước, sau đó bạn có thể thêm phiên bản (SKU, giá, tồn kho) và tải hình ảnh / video.
            </p>
