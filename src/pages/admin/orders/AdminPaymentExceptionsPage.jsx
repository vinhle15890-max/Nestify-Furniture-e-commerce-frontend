...
export function AdminPaymentExceptionsPage() {
  ...
  return <div className="flex flex-col gap-6">
    <div><h1 className="font-display text-2xl text-foreground">Ngoại lệ thanh toán</h1><p className="mt-1 text-sm text-muted-foreground">Tiền PayOS đã được xác minh nhưng trạng thái giao hàng không thể tự động khôi phục.</p></div>
