    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="flex flex-col gap-4">
        ...
        <fieldset className="space-y-3 rounded-control border border-border p-4">
          ...
          <label className="flex items-start gap-3 text-sm"><input type="checkbox" {...register('is_public')} /><span><strong className="block font-medium">Hiển thị ở nơi nhận voucher</strong><span className="text-muted-foreground">Khách có thể tìm thấy campaign công khai.</span></span></label>
