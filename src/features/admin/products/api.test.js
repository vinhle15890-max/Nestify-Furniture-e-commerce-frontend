...
import { confirmVariantModel, measureVariantModel, presignVariantModel, uploadModel } from './api'
...
it('keeps the development R2 diagnostic upload contract available', () => {
  const formData = new FormData()
  uploadModel(formData)

  expect(apiClient.post).toHaveBeenCalledWith('/admin/uploads', formData, {
